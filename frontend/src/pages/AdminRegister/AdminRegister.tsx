...
const Register: React.FC = observer(() => {
  ...
  //   ! RETURN
  return (
    <Grid container justify="center" alignContent="center" className="adminRegister">
      <Grid
        container
        justify="center"
        alignItems="center"
        item
        xs={10}
        className="adminRegister__titleBar"
      >
        <Title destination="modal" />
      </Grid>
      <Grid item xs={10} className="adminRegister__grid">
        <Paper elevation={3} className="adminRegister__paper">
          <TextField
            id="name"
            label="Name"
            variant="outlined"
